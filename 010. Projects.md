...
I did look at the hints, after some time trying. I just used the hint to create the two arrays below, which I did, but then again, I think I have more elements than they do. Moreover I used the indexOf hint. But I didn't use slice. And I checked the numbers by their length.
```
