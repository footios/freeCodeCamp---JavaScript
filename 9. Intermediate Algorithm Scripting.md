...
```
    function translatePigLatin(str) {
      ...
      // If it starts with a consonant and the last is not a vowel
        ...
        // We get: ["f", index: 0, input: "fefffa", groups: undefined]
        // So if we log consonants.index is 0, and .input is feffa.
...
> The FCC intermediate solution has a very interesting line of code.
>
> First of all it's very consice. It uses only one regex. Then it orders the if statements in a very accurate way.
> 
> Check also the intermadiate and advanced solutions... => wow am I ever going to write code like that!
...
>
> Check a very nice intermediate solution on [FCC](https://guide.freecodecamp.org/certifications/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/dna-pairing/)
```
