...
* I got a hint [from Josh Pitzalis's article](https://medium.freecodecamp.org/reduce-f47a7da511a9)
```
...
```
    // Ok! So then I got an idea from Josh Pitzalis's article
    // to solve the problem by using just the reduce method
